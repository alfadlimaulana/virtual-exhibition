            ...
            <div class="xl:w-3/5 border p-8 border-black rounded-lg shadow-lg bg-brand-cream">
                <div class="w-full mx-auto">
                    ...
                    <div class="flex items-center p-4 mb-4 text-sm text-red-800 rounded-lg bg-red-50" role="alert">
                        ...
                        <div>
                          {{ $painting->feedbacks->sortByDesc('created_at')->first()->message }}
                        </div>
                    </div>
                    @else
                    <div class="flex items-center p-2.5 mb-2 text-sm text-yellow-800 border border-yellow-300 rounded-lg bg-yellow-50" role="alert">
                        ...
                        <span class="sr-only">Info</span>
                        <div>
                            <span class="font-medium">Warning!</span> Perubahan data membuat lukisan perlu ditinjau ulang oleh kurator.
                        </div>
                    </div>
                    @endif
